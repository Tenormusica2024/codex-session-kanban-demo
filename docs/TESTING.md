...
- `/` focuses search and filters both board cards and candidates, the filter summary updates, `x` clears filters, `?` opens/closes the workflow guide, and `Esc` closes it
