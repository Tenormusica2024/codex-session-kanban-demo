...
- Follow-up added `/` search focus, `?` workflow-guide toggle, `Esc` guide close, `x` clear-filters, candidate-list filtering, and browser smoke coverage for these no-mouse review shortcuts.
